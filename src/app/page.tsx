          ...
          <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div className="flex lg:flex-1">
              <a href="/" className="shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600">
                ...
                <img className="h-16 w-auto" src="a2.svg" alt="A Squared - Development" />
              </a>
            </div>
      ...
      <div className="bg-white border-y border-solid">
        <div className="mx-auto max-w-7xl pt-24 pb-32 px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-sm sm:grid-cols-4 sm:gap-x-10 md:mx-0 md:max-w-none md:grid-cols-4">
            <img className="col-span-2 max-h-12 w-full object-contain md:col-span-1" src="doctify.svg" alt="Doctify" />
            <img className="col-span-2 max-h-12 w-full object-contain md:col-span-1" src="akqa.svg" alt="AKQA" />
            <img className="col-span-2 max-h-12 w-full object-contain md:col-span-1" src="mintago.svg" alt="Mintago" />
            <img className="col-span-2 max-h-12 w-full object-contain md:col-span-1" src="perkbox.svg" alt="Perkbox" />
          </div>
        </div>
      </div>
